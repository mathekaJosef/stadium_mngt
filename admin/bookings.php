...
<html>
  ...
  <body>
      ...
      <div class="row">
        <div class="column" id="sidebar">
          <div class="ui secondary vertical fluid menu">
            <a class="active item" href="bookings.php">Bookings</a><a class="item" href="transactions.php">Transactions</a><a class="item" href="arrangementclass.php">Arrangement Classes</a><a class="item">Export</a>
			    </div>
        </div>
	...
	<div class="ui grid">
            <div class="row">
         <h1 class="ui huge header">All Stadium Bookings</h1></div>
        <div class="ui horizontal divider"> These are the Bookings Details</div>      
		<?php 
//rejection
