...
$("#payment-info").html("Confirm the payment of the number of seats booked");
return false;	
...
$("#details").html("<ul><li>TICKET OWNER: "+fullname+"</li><li>STADIUM/VENUE: "+destination+"</li><li>DATE OF EVENT: "+traveldate+"</li><li>CLASS PER STADIUM ARRANGEMENT: "+travelclass+"</li><li>NUMBER OF SEATS BOOKED: "+seats+"</li><li>AMOUNT PAID: "+amount+" Via "+paymethod+" Transaction ID: "+code+"</li></ul>");	
